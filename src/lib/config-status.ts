...
const PROVIDER_CONFIGS: ProviderConfigDescriptor[] = [
  ...
  { key: "trafft", label: "Trafft", envKeys: ["TRAFFT_API_URL", "TRAFFT_CLIENT_ID", "TRAFFT_CLIENT_SECRET", "TRAFFT_BEARER_TOKEN", "TRAFFT_WEBHOOK_VERIFICATION_TOKEN", "TRAFFT_DEFAULT_SERVICE_ID", "TRAFFT_SERVICE_MAP"], embedded: Boolean(embeddedSecrets.trafft.apiUrl && embeddedSecrets.trafft.clientId && embeddedSecrets.trafft.clientSecret), notes: "Trafft is fully live for public booking; add the webhook verification token to authenticate inbound appointment events." },
